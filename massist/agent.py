...
def get_agent(agent_id: str, topic: str, params: AgentParams, tools: List[Any] | None = None):
...
def get_search_agent(agent_id: str, topic: str, params: AgentParams, tools: List[Any] | None = None):
    meta = Meta(agent_id=agent_id, topic=topic)
    # FIXME: remove default stolyarchuk
